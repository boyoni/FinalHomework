...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private TextView item_detail, item_category;
    ...
    private AlertDialog alertDialog_AddRecord;//点击＋按钮时弹出提示框

    String[] titles = new String[]{"明细", "类别报表"};
    private static final String[] yearList = {PublicFunction.getTime("Y") + "年"};
    ...
    private void initSpinner(){
        ...
        //设置默认值
        month_spinner.setSelection(PublicFunction.getTime("M"), true);
    ...
    private void changeTextColor(int position) {
        if (position == 0) {
            item_detail.setTextColor(Color.parseColor("#1ba0e1"));
            item_category.setTextColor(Color.parseColor("#000000"));
            /*
            gone：表示不可见并且不占用空间
            visible：表示可见
            ...
            item_category.setTextColor(Color.parseColor("#1ba0e1"));
